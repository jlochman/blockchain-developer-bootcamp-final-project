...
contract("Marketplace", function (accounts) {
  ...
  describe("Claim Reward", () => {
    ...
    it("creators get their royalties, seller and marketplace their reward", async function () {
      ...
      console.log(`${marketplaceBalanceChange}, ${aliceBalanceChange}, ${bobBalanceChange}, ${creatorBalanceChange}`);
  ...
  /*
        ...
        var response = await marketplace.getAuction(mockNft.address, 3);
      assert.equal(response[2], 10000, "start price must be 10000");
